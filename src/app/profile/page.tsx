    ...
    <ProfileTemplate>
      ...
      <div className="flex flex-col gap-8">
        ...
        <form className="flex flex-col gap-6 w-full">
          ...
          <button type="button" className="mt-4 bg-[#FF7A5C] text-sm text-white px-6 py-2 rounded-md self-start disabled:opacity-60 hover:bg-[#ff6b4a] transition-colors" disabled={!isEditing} onClick={() => setIsEditing(false)}>
            Save Changes
          </button>
        </form>
      </div>
