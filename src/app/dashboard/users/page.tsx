                ...
                <div className="bg-white/60 border-2 rounded-3xl p-6 transform transition-all duration-500 ease-out hover:scale-[1.02]">
                  <div className="flex flex-col items-center relative">
                    <button
                      ...
                      className="absolute top-0 right-0 p-2 text-slate-500 hover:text-slate-700 transition-colors cursor-pointer"
                    >
                      <svg
                    ...
                    <img
                      ...
                      className="w-32 h-32 md:w-40 md:h-40 rounded-full mb-6 object-cover animate-fade-in"
                    />
                    <h1 className="text-lg font-semibold text-gray-900 text-center animate-fade-in-delay-1">
                      {selectedUser.name}
                    </h1>
                    <p className="text-slate-500 text-center animate-fade-in-delay-2">
                      {selectedUser.email}
                    </p>
                      ...
                      <div className="bg-white rounded-xl p-3 text-center transform transition-all duration-300 ease-out hover:scale-105">
                        ...
                        <p className="text-slate-700 font-medium text-sm">
                          {selectedUser.createdAt
                            ? new Date(
                                selectedUser.createdAt
                              ).toLocaleDateString("id-ID") // DIUBAH: Format tanggal ke Indonesia
                            : "N/A"}
                        </p>
                      </div>
                    </div>
