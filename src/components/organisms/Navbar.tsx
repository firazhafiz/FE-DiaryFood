  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto flex flex-col gap-2">
            ...
            <div className="w-6 h-5 flex flex-col justify-between">
              <span
                className={`w-full h-0.5 ${
                  ...
                  isMobileMenuOpen ? "rotate-45 translate-y-2 bg-black" : ""
                }`}
              ></span>
              <span
                className={`w-full h-0.5 ${
        ...
        >
          <div className="px-6 py-8 space-y-6">
            ...
            <div className="pt-4">
              {!isLoggedIn && (
                <div className="flex justify-center gap-4">
                  <Link
                    href="/login"
                    className="w-[120px] py-2.5 text-center font-medium border-2 border-[var(--custom-orange)] rounded-lg text-gray-800 hover:bg-gray-50 transition-colors duration-200"
                  >
                    Login
                  </Link>
                  <Link
                    href="/register"
                    className="w-[120px] py-2.5 text-center font-medium bg-[var(--custom-orange)] text-white rounded-lg hover:bg-[var(--custom-orange)]/90 transition-colors duration-200"
                  >
                    Sign Up
                  </Link>
                </div>
            ...
            <div className="flex flex-col gap-6 pt-6">
              <Link
                href="/"
                className={`text-gray-800 hover:text-[var(--custom-orange)] font-medium text-lg transition-colors duration-200`}
              >
                Home
              </Link>
              <Link
        ...
        {/* Category Navigation */}
        <div
          className={`hidden md:flex justify-start gap-12 overflow-x-auto bg-cover py-2 ${
