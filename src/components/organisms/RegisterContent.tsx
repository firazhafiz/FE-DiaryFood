...
export const RegisterContent: React.FC<RegisterContentProps> = ({ onSubmit }) => {
  return (
    <div className="w-full max-w-md m-auto p-8">
      <Title />
      <h2 className="mt-2 text-slate-800 font-bold text-3xl">Create your Account</h2>
      <p className="mt-1 text-slate-400">Join us! Select method to create your account:</p>
