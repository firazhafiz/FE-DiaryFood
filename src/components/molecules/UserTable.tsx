...
const UserRow: React.FC<UserRowProps> = ({ id, email, username, index, photo, onDelete, onShow }) => {
  ...
  return (
    <div className="flex justify-between items-center bg-white/60 border-2 rounded-lg p-4">
      <div className="flex items-center gap-2">
        ...
        <Image src={photo ? photo : DefaultProfile} alt="user" className="w-10 h-10 rounded-full" height={100} width={100} />
