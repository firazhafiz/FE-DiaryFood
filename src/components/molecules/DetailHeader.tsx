  ...
  return (
    <div className="mb-8">
      ...
      <div className="flex flex-wrap items-center gap-4 text-xs text-gray-500 mb-4 justify-between">
        <div className="flex flex-wrap items-center gap-4">
          ...
          <span
            className={`flex items-center gap-1 cursor-pointer ${
              rated
                ? "text-[color:var(--custom-orange)]"
                : "text-gray-500 hover:text-[color:var(--custom-orange)]"
            }`}
            onClick={handleRate}
          >
            <svg
        ...
        <button
          className="flex items-center cursor-pointer gap-1 px-3 py-1 rounded-md border border-gray-200 text-xs text-gray-600 hover:bg-gray-100 transition-colors"
          onClick={handleShare}
        >
          <svg
            className="w-4 h-4 "
