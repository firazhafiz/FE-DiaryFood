  ...
  return (
    <div className="">
      <div className="flex justify-between mb-6">
        <Link
          href={"/profile/my-recipe/add-recipe"}
          className="bg-[var(--custom-orange)] text-white px-4 py-1 rounded-md text-xs font-medium hover:bg-[var(--custom-orange)]/90 transition-colors flex items-center gap-2"
        >
      ...
      <div className="rounded-xl ">
        <div className="grid grid-cols-5 py-4 px-6 border-b">
          <p className="text-slate-700 font-medium text-sm col-span-2">
            Recipe
          </p>
          <p className="text-slate-700 font-medium text-sm">Category</p>
          <p className="text-slate-700 font-medium text-sm">Status</p>
          <p className="text-slate-700 font-medium text-sm text-right pr-3">
            Actions
          </p>
        </div>
